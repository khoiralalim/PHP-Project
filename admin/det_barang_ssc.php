...
<a class="btn" href="ssc.php"><span class="glyphicon glyphicon-arrow-left"></span>  Kembali</a>
...
$det=mysql_query("select * from tb_grc_accept where id='$id_brg'")or die(mysql_error());
