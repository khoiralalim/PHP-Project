...
$pdf->Cell(25.5,0.7,"SURAT KETERANGAN PENGELUARAN BARANG",0,10,'C');


$pdf->SetFont('Arial','B',12);
$pdf->Cell(25.5,0.7,"( Goods Removal Certificate )",0,10,'C');
...
$pdf->SetFont('Arial','',10);
$no=1;
$query=mysql_query("select * from tb_grc");
...
$pdf->Output("Cetak_SiGores.pdf","I");
